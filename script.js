...
const registerDrawerDisplay = document.getElementById('register-drawer-display');
...
const updateUI = change => {
  ...
  registerDrawerDisplay.innerHTML = `<p><strong>Change in drawer:</strong></p>
    ${cid
